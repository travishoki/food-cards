import { CATEGORY_DATA, TOP_CATEGORY_DATA, TOP_CATEGORY_ORDER, TOP_CATEGORY_SUBCATEGORIES } from "../categories"
...
export function subCategoriesForTop(topKey: string) {
    const keys = TOP_CATEGORY_SUBCATEGORIES[topKey as keyof typeof TOP_CATEGORY_SUBCATEGORIES] ?? []
